...
export async function GET(req) {
  try {
    ...
    if (!userId) return err(400, "Missing userId", "userId is required.");
    ...
    return ok({ userId, deliveryLocations: locations });
  } catch (e) {
    console.error("GET_LOCATIONS_ERROR:", e);
    return err(500, "Server Error", "Failed to fetch delivery locations.", { details: e.message });
  }
}
